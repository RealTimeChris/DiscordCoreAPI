...
namespace DiscordCoreAPI {
	...
	*/
	...
	inline void parseObject(const nlohmann::json* jsonObjectData, UserData& theData) {
		theData.flags = DiscordCoreAPI::setBool<int32_t, DiscordCoreAPI::UserFlags>(theData.flags, DiscordCoreAPI::UserFlags::MFAEnabled,
			DiscordCoreAPI::getBoolReal(jsonObjectData, "mfa_enabled"));

		theData.flags = DiscordCoreAPI::setBool<int32_t, DiscordCoreAPI::UserFlags>(theData.flags, DiscordCoreAPI::UserFlags::Verified,
			DiscordCoreAPI::getBoolReal(jsonObjectData, "verified"));

		theData.flags =
			DiscordCoreAPI::setBool<int32_t, DiscordCoreAPI::UserFlags>(theData.flags, DiscordCoreAPI::UserFlags::System, DiscordCoreAPI::getBoolReal(jsonObjectData, "system"));

		theData.flags =
			DiscordCoreAPI::setBool<int32_t, DiscordCoreAPI::UserFlags>(theData.flags, DiscordCoreAPI::UserFlags::Bot, DiscordCoreAPI::getBoolReal(jsonObjectData, "bot"));

		theData.discriminator = DiscordCoreAPI::getString(jsonObjectData, "discriminator");

		theData.flags = DiscordCoreAPI::getUint32(jsonObjectData, "public_flags");

		theData.userName = DiscordCoreAPI::getString(jsonObjectData, "username");

		theData.id = DiscordCoreAPI::strtoull(DiscordCoreAPI::getString(jsonObjectData, "id"));

		theData.avatar = DiscordCoreAPI::getString(jsonObjectData, "avatar");
	}
	...
	struct DiscordCoreAPI_Dll ThreadMetadataData {
		...
		uint64_t archiveTimestamp{};///< (Where applicable) the time at which this Thread was archived.
	...
	class DiscordCoreAPI_Dll ThreadMemberData : public DiscordEntity {
	  public:
		uint64_t joinTimestamp{};///< The time at which the member joined this Thread.
	...
	inline void parseObject(const nlohmann::json* jsonObjectData, GuildMemberData& theData) {
		theData.flags = DiscordCoreAPI::setBool<int8_t, DiscordCoreAPI::GuildMemberFlags>(theData.flags, DiscordCoreAPI::GuildMemberFlags::Pending,
			DiscordCoreAPI::getBoolReal(jsonObjectData, "pending"));

		theData.flags =
			setBool<int8_t, DiscordCoreAPI::GuildMemberFlags>(theData.flags, DiscordCoreAPI::GuildMemberFlags::Mute, DiscordCoreAPI::getBoolReal(jsonObjectData, "mute"));

		theData.flags =
			setBool<int8_t, DiscordCoreAPI::GuildMemberFlags>(theData.flags, DiscordCoreAPI::GuildMemberFlags::Deaf, DiscordCoreAPI::getBoolReal(jsonObjectData, "deaf"));

		theData.joinedAt = DiscordCoreAPI::TimeStamp<std::chrono::milliseconds>(DiscordCoreAPI::getString(jsonObjectData, "joined_at"));
		...
		for (auto& value: theVector) {
			theData.roles.push_back(stoull(std::move(value)));
		}

		theData.permissions = DiscordCoreAPI::getUint64(jsonObjectData, "permissions");

		std::unique_ptr<DiscordCoreAPI::UserData> theUser = std::make_unique<DiscordCoreAPI::UserData>();
		...
		theData.flags = DiscordCoreAPI::getUint8(jsonObjectData, "flags");

		theData.nick = DiscordCoreAPI::getString(jsonObjectData, "nick");
	}
	...
	void from_json(const nlohmann::json& jsonObjectData, DiscordCoreAPI::ChannelData& theGuild);
	...
	class DiscordCoreAPI_Dll RoleData : public DiscordEntity {
	  public:
		...
		uint64_t permissions{};///< The Role's base Guild Permissions.
	...
	void from_json(const nlohmann::json& jsonObjectData, DiscordCoreAPI::RoleData& theGuild);
	...
	class DiscordCoreAPI_Dll GuildScheduledEventDataVector {
	  public:
		...
		GuildScheduledEventDataVector& operator=(const nlohmann::json* jsonObjectData);

		GuildScheduledEventDataVector(const nlohmann::json* jsonObjectData);

		virtual ~GuildScheduledEventDataVector() = default;
	...
	struct DiscordCoreAPI_Dll InviteData {
		...
		uint64_t createdAt{};///< Time it was created at.
		uint64_t expiresAt{};///< When the invite expires.
	...
	struct DiscordCoreAPI_Dll ChannelPinsUpdateEventData {
		uint64_t lastPinTimestamp{};///< The time of the last pinned Message.
...
namespace nlohmann {
	...
	template<> struct adl_serializer<DiscordCoreAPI::RoleData> {
		static DiscordCoreAPI::RoleData from_json(const json& j) {
			DiscordCoreAPI::RoleData theRole{};

			theRole.id = DiscordCoreAPI::strtoull(DiscordCoreAPI::getString(&j, "id"));

			theRole.name = DiscordCoreAPI::getString(&j, "name");

			std::stringstream theStream{};
			theStream << DiscordCoreAPI::getString(&j, "unicode_emoji");
			...
			theRole.color = DiscordCoreAPI::getUint32(&j, "color");

			theRole.flags = DiscordCoreAPI::setBool<int8_t, DiscordCoreAPI::RoleFlags>(theRole.flags, DiscordCoreAPI::RoleFlags::Hoist, DiscordCoreAPI::getBoolReal(&j, "hoist"));

			theRole.flags =
				DiscordCoreAPI::setBool<int8_t, DiscordCoreAPI::RoleFlags>(theRole.flags, DiscordCoreAPI::RoleFlags::Managed, DiscordCoreAPI::getBoolReal(&j, "managed"));

			theRole.flags =
				DiscordCoreAPI::setBool<int8_t, DiscordCoreAPI::RoleFlags>(theRole.flags, DiscordCoreAPI::RoleFlags::Mentionable, DiscordCoreAPI::getBoolReal(&j, "mentionable"));

			theRole.position = DiscordCoreAPI::getUint32(&j, "position");

			theRole.permissions = DiscordCoreAPI::Permissions{ DiscordCoreAPI::getString(&j, "permissions") };
			return theRole;
		}
	};

	template<> struct adl_serializer<DiscordCoreAPI::OverWriteData> {
		static DiscordCoreAPI::OverWriteData from_json(const json& j) {
	...
	template<> struct adl_serializer<DiscordCoreAPI::ChannelData> {
		static DiscordCoreAPI::ChannelData from_json(const json& j) {
			DiscordCoreAPI::ChannelData theChannel{};

			theChannel.id = DiscordCoreAPI::strtoull(DiscordCoreAPI::getString(&j, "id"));

			theChannel.flags = DiscordCoreAPI::getUint8(&j, "flags");

			theChannel.type = static_cast<DiscordCoreAPI::ChannelType>(DiscordCoreAPI::getUint8(&j, "type"));

			theChannel.parentId = DiscordCoreAPI::strtoull(DiscordCoreAPI::getString(&j, "parent_id"));

			theChannel.guildId = DiscordCoreAPI::strtoull(DiscordCoreAPI::getString(&j, "guild_id"));

			theChannel.position = DiscordCoreAPI::getUint32(&j, "position");

			if (j.contains("permission_overwrites") && !j["permission_overwrites"].is_null()) {
				theChannel.permissionOverwrites.clear();
				theChannel.permissionOverwrites.reserve(j["permission_overwrites"].size());
				for (auto& value: j["permission_overwrites"]) {
					theChannel.permissionOverwrites.push_back(value.get<DiscordCoreAPI::OverWriteData>());
				}
			}

			theChannel.name = DiscordCoreAPI::getString(&j, "name");

			theChannel.flags =
				DiscordCoreAPI::setBool<int8_t, DiscordCoreAPI::ChannelFlags>(theChannel.flags, DiscordCoreAPI::ChannelFlags::NSFW, DiscordCoreAPI::getBoolReal(&j, "nsfw"));

			theChannel.ownerId = DiscordCoreAPI::strtoull(DiscordCoreAPI::getString(&j, "owner_id"));

			theChannel.memberCount = DiscordCoreAPI::getUint32(&j, "member_count");
			return theChannel;
		}
	};
