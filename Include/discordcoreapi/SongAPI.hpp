...
namespace DiscordCoreAPI {
	...
	class DiscordCoreAPI_Dll SongAPI {
	  public:
		...
		SongAPI( const std::string& guildId);
		...
		static void onSongCompletion(std::function<CoRoutine<void>(SongCompletionEventData)> handler,  const std::string& guildId);
		...
		static std::vector<Song> searchForSong( const std::string& searchQuery,  const std::string& guildId);
		...
		static bool isThereAnySongs( const std::string& guildId);
		...
		static bool play( const std::string& guildId);
		...
		static void stop( const std::string& guildId);
		...
		static void pauseToggle( const std::string& guildId);
		...
		static bool areWeCurrentlyPlaying( const std::string& guildId);
		...
		/// \returns A Playlist.
		static Playlist getPlaylist( const std::string& guildId);
		...
		static bool isLoopAllEnabled( const std::string& guildId);
		...
		static void setLoopAllStatus(bool enabled,  const std::string& guildId);
		...
		static bool isLoopSongEnabled( const std::string& guildId);
		...
		/// \param guildId The Guild id for which Guild to update this status in.
		static void setLoopSongStatus(bool enabled,  const std::string& guildId);
		...
		static void modifyQueue(int32_t firstSongPosition, int32_t secondSongPosition,  const std::string& guildId);
		...
		static Song getCurrentSong( const std::string& guildId);
