...
namespace DiscordCoreAPI {
	...
	class DiscordCoreAPI_Dll SongAPI {
	  public:
		...
		static void onSongCompletion(std::function<CoRoutine<void>(SongCompletionEventData)> handler, const int64_t& guildId);
		...
		static std::vector<Song> searchForSong(const std::string& searchQuery, const int64_t& guildId);
		...
		static bool isThereAnySongs(const int64_t& guildId);
		...
		static bool play(const int64_t& guildId);
		...
		static void stop(const int64_t& guildId);
		...
		static void pauseToggle(const int64_t& guildId);
		...
		static bool areWeCurrentlyPlaying(const int64_t& guildId);
		...
		/// \returns A Playlist.
		static Playlist getPlaylist(const int64_t& guildId);
		...
		static void setPlaylist(const Playlist& playlistNew, const int64_t& guildId);
		...
		static bool isLoopAllEnabled(const int64_t& guildId);
		...
		static void setLoopAllStatus(bool enabled, const int64_t& guildId);
		...
		static bool isLoopSongEnabled(const int64_t& guildId);
		...
		/// \param guildId The Guild id for which Guild to update this status in.
		static void setLoopSongStatus(bool enabled, const int64_t& guildId);
		...
		static void modifyQueue(int32_t firstSongPosition, int32_t secondSongPosition, const int64_t& guildId);
		...
		static Song getCurrentSong(const int64_t& guildId);
		...
		static void setCurrentSong(const Song& song, const int64_t& guildId);
