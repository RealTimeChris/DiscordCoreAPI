...
namespace DiscordCoreAPI {
	...
	class DiscordCoreAPI_Dll ExecuteWebHookData {
	  public:
		...
		ExecuteWebHookData& addButton(bool disabled, std::string const& customIdNew, std::string const& buttonLabel, ButtonStyle buttonStyle, std::string const& emojiName = "",
		...
		ExecuteWebHookData addSelectMenu(bool disabled, std::string const& customIdNew, std::vector<SelectOptionData> options, std::string const& placeholder, int32_t maxValues,
			int32_t minValues) {
			if (this->components.size() == 0) {
				ActionRowData actionRowData;
				this->components.push_back(actionRowData);
		...
		ExecuteWebHookData& addModal(std::string const& topTitleNew, std::string const& topCustomIdNew, std::string const& titleNew, std::string const& customIdNew, bool required, int32_t minLength,
		...
		ExecuteWebHookData& addContent(std::string const& dataPackage) {
