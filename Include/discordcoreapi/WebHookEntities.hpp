...
namespace DiscordCoreAPI {
	...
	class DiscordCoreAPI_Dll ExecuteWebHookData {
	  public:
		...
		int64_t threadId{};///< Send a message to the specified thread within a webhook's Channel. The thread will automatically be unarchived.
	  ...
	  protected:
		...
		int64_t webhookId{};///< The WebHook you would like to execute.
	...
	struct DiscordCoreAPI_Dll GetWebHookData {
		int64_t webhookId{};///< Id of the desired WebHook to collect.
	};
	...
	struct DiscordCoreAPI_Dll GetWebHookWithTokenData {
		...
		int64_t webhookId{};///< Id of the desired WebHook.
	};
	...
	struct DiscordCoreAPI_Dll ModifyWebHookData {
		...
		int64_t webhookId{};///< The WebHook to be modified.
	...
	struct DiscordCoreAPI_Dll DeleteWebHookData {
		int64_t webhookId{};///< The desired WebHook to delete.
	};
	...
	struct DiscordCoreAPI_Dll GetWebHookMessageData {
		...
		int64_t webhookId{};///< The WebHook you would like to collect.
		uint64_t messageId{};///< The Message Id to collect.
		int64_t threadId{};///< The thread that the Message is in.
	};
