...
namespace DiscordCoreAPI {
	...
	class DiscordCoreAPI_Dll InputEvents {
	  public:
		...
		static std::unique_ptr<InputEventData> respondToEvent(RespondToInputEventData dataPackage);
		...
		static CoRoutine<void> deleteInputEventResponseAsync(std::unique_ptr<InputEventData> dataPackage, int32_t timeDelayNew = 0);
	  ...
	  protected:
		...
		static InputEventData respondToEvent(EditEphemeralInteractionResponseData dataPackage);

		static InputEventData respondToEvent(CreateEphemeralFollowUpMessageData dataPackage);

		static InputEventData respondToEvent(EditEphemeralFollowUpMessageData dataPackage);
