...
namespace DiscordCoreAPI {
	...
	class DiscordCoreAPI_Dll CreateMessageData : public MessageResponseBase {
	  public:
		friend nlohmann::json DiscordCoreInternal::JSONIFY(CreateMessageData dataPackage);
		friend InputEvents;
		friend Messages;
	...
	class DiscordCoreAPI_Dll EditMessageData : public MessageResponseBase {
	  public:
		friend nlohmann::json DiscordCoreInternal::JSONIFY(EditMessageData dataPackage);
		friend InputEvents;
		friend Messages;
