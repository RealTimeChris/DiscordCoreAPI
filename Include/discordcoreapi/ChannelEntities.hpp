...
namespace DiscordCoreAPI {
	...
	class DiscordCoreAPI_Dll Channel : public ChannelData {
	  public:
		...
		std::unordered_map<Snowflake, UserData> recipients{};///< Recipients, in the case of a group Dm or m.
	...
	class DiscordCoreAPI_Dll Channels {
	  public:
		template<typename ReturnType> friend void parseObject(simdjson::simdjson_result<simdjson::fallback::ondemand::object>& theParser, const char* keyName, ReturnType& theData);
