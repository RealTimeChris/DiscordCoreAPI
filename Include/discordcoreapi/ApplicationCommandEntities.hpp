...
namespace DiscordCoreAPI {
	...
	struct DiscordCoreAPI_Dll CreateGlobalApplicationCommandData {
		std::unordered_map<std::string, std::string> descriptionLocalizations{};///< Dictionary with keys in available locales Localization dictionary for the description field. Values follow the same restrictions as description.
