...
namespace DiscordCoreAPI {
	...
	struct DiscordCoreAPI_Dll CreateGlobalApplicationCommandData {
		...
		std::vector<ApplicationCommandOptionData>
			options{};///< The options for the ApplicationCommand.
		std::string
			defaultMemberPermissions{};///< Set of permissions represented as a bit set. only for globally - scoped commands.
	...
	struct DiscordCoreAPI_Dll BulkOverwriteGlobalApplicationCommandsData {
		std::vector<CreateGlobalApplicationCommandData>
			responseData{};///< A std::vector of the options for the ApplicationCommands.
		uint64_t applicationId{};///< The current application's Id (The Bot's User Id).
	};
	...
	struct DiscordCoreAPI_Dll GetGuildApplicationCommandsData {
		...
		uint64_t applicationId{};///< The current application's Id (The Bot's User Id).
		uint64_t
			guildId{};///< The id of the Guild for which you would like to acquire the ApplicationCommands from.
	};
	...
	struct DiscordCoreAPI_Dll GetGuildApplicationCommandData {
		...
		uint64_t
			guildId{};///< The id of the Guild from which you would like to acquire the ApplicationCommand from.
	};
	...
	struct DiscordCoreAPI_Dll BulkOverwriteGuildApplicationCommandsData {
		std::vector<CreateGuildApplicationCommandData>
			responseData{};///< A std::vector of the options for the ApplicationCommands.
		uint64_t applicationId{};///< The current application's Id (The Bot's User Id).
		uint64_t
			guildId{};///< The id of the Guild which you would like to overwrite the commands of.
	};
	...
	struct DiscordCoreAPI_Dll GetGuildApplicationCommandPermissionsData {
		uint64_t applicationId{};///< The current application's Id (The Bot's User Id).
		uint64_t
			guildId{};///< The id of the Guild from which you would like to acquire the command permissions.
	};
	...
	struct DiscordCoreAPI_Dll GetApplicationCommandPermissionsData {
		std::string
			commandName{};///< The name of the command which you would like to collect the permissions of.
		uint64_t applicationId{};///< The current application's Id (The Bot's User Id).
		uint64_t
			guildId{};///< The id of the Guild from which you would like to acquire the command permissions.
	};
	...
	struct DiscordCoreAPI_Dll EditGuildApplicationCommandPermissionsData {
		std::vector<ApplicationCommandPermissionData>
			permissions{};///< A std::vector of ApplicationCommand permissions.
		std::string
			commandName{};///< The command name which you would like to edit the permissions of.
		uint64_t applicationId{};///< The current application's Id (The Bot's User Id).
		uint64_t commandId{};///< The command id which you would like to edit the permissions of.
		uint64_t
			guildId{};///< The Guild id of the Guild for which you would like to edit the command permissions.
	};
	...
	struct DiscordCoreAPI_Dll BatchEditGuildApplicationCommandPermissionsData {
		std::vector<GuildApplicationCommandPermissionsData>
			permissions{};///< A std::vector of edit-Guild-application-permissions responseData to edit.
		uint64_t applicationId{};///< The current application's Id (The Bot's User Id).
		uint64_t
			guildId{};///< The Guild id of the Guild for which you would like to batch edit Guild application permissions.
	};
	...
	class DiscordCoreAPI_Dll ApplicationCommands {
	  public:
		...
		static CoRoutine<std::vector<ApplicationCommand>> getGlobalApplicationCommandsAsync(
		...
		static CoRoutine<ApplicationCommand> createGlobalApplicationCommandAsync(
		...
		/// \returns A CoRoutine containing an ApplicationCommand.
		static CoRoutine<ApplicationCommand> getGlobalApplicationCommandAsync(
		...
		/// \returns A CoRoutine containing an ApplicationCommand.
		static CoRoutine<ApplicationCommand> editGlobalApplicationCommandAsync(
		...
		static CoRoutine<void> deleteGlobalApplicationCommandAsync(
		...
		/// \returns A CoRoutine containing a std::vector<ApplicationCommand>.
		static CoRoutine<std::vector<ApplicationCommand>>
		...
		/// \returns A CoRoutine containing a std::vector<ApplicationCommand>.
		static CoRoutine<std::vector<ApplicationCommand>> getGuildApplicationCommandsAsync(
		...
		/// \returns A CoRoutine containing an ApplicationCommand.
		static CoRoutine<ApplicationCommand> createGuildApplicationCommandAsync(
		...
		/// \returns A CoRoutine containing an ApplicationCommand.
		static CoRoutine<ApplicationCommand> getGuildApplicationCommandAsync(
		...
		/// \returns A CoRoutine containing an ApplicationCommand.
		static CoRoutine<ApplicationCommand> editGuildApplicationCommandAsync(
		...
		/// \returns A CoRoutine containing void.
		static CoRoutine<void> deleteGuildApplicationCommandAsync(
		...
		static CoRoutine<std::vector<GuildApplicationCommandPermissionsData>>
		...
		static CoRoutine<GuildApplicationCommandPermissionsData>
		getApplicationCommandPermissionsAsync(GetApplicationCommandPermissionsData dataPackage);
