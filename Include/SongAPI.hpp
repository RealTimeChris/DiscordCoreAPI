...
namespace DiscordCoreAPI {
	...
	*/
	...
	public:
		...
		UniEvent<void, SongCompletionEventData> onSongCompletionEvent{};
		Playlist playlist{};
		...
		static void onSongCompletion(std::function<void(SongCompletionEventData)> handler, std::string guildId);
