...
namespace DiscordCoreAPI {
	...
	void SoundCloudSong::initialize(string baseSearchURLNew, string baseSearchURL2New) {
		SoundCloudSong::baseSearchURL = baseSearchURLNew;
		SoundCloudSong::baseSearchURL02 = baseSearchURL2New;
	...
	vector<SoundCloudSong> SoundCloudSong::searchForSong(string songQuery) {
		...
		for (auto value : returnData.data.at("collection")) {
			SoundCloudSong newSong = SoundCloudSong{ SoundCloudSong::baseSearchURL, SoundCloudSong::baseSearchURL02 };
	...
	SoundCloudSong::SoundCloudSong(string baseSearchURLNew, string baseSearchURL02New) {
		string baseSearchFinal = baseSearchURLNew;
		string baseSearch02Final = baseSearchURL02New;
	...
	protected:
		...
		task<void> downloadAndStreamAudioWrapper(Song newSong, SoundCloudAPI* soundCloudAPI) {
