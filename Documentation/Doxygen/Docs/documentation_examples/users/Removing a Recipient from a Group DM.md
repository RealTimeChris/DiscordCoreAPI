...
============
- Execute the, `users::removeRecipientFromGroupDMAsync()` function, while passing in a value of type `remove_recipient_from_group_dmdata`, with a return value of type `void`.
