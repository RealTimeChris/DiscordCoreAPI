Deleting a Guild Template {#deletingaguildtemplate}
============
- Execute the, `guilds::deleteGuildTemplateAsync()` function, while passing in a value of type `delete_guild_template_data`, with a return value of type `void`.
