Getting a WebHook using a Discord Bot Library C++ {#gettingawebhook}
=============
- Execute the, `discord_core_api::web_hooks::getWebHookAsync()` function, while passing in a value of type `get_web_hook_data`, with a return value of type `auto` or `web_hook`.
