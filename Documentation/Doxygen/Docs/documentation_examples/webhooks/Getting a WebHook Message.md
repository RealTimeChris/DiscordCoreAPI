Getting a WebHook Message using a Discord Bot Library C++ {#gettingawebhookmessage}
============
- Execute the, `discord_core_api::web_hooks::getWebHookMessageAsync()` function, while passing in a value of type `get_web_hook_message_data`, with a return value of type `auto` or `message`.
