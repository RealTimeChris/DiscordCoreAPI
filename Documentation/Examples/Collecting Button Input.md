...
---
- After creating a button, create an object of then `DiscordCoreAPI::ButtonCollector` class, passing into its constructor the `InputEventData` that resulted from the call to `InputEvents::respondToEvent`.
