...
- Select, from the `Channels` class, the `addThreadMemberAsync()` function and execute it, with a return value of type `auto` or `Channel`, while passing it the created data structure.
