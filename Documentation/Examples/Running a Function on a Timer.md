...
- Pass a reference to this vector as a second argument to the `DiscordCoreAPI::DiscordCoreClient::finalSetup()` function - now the functions it contains will run on a schedule defined by the `intervalInMS` member of the data structure.
