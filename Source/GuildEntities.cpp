...
namespace DiscordCoreAPI {
	...
	CreateGuildData::operator String() {
		JsonObject theData{};
	...
	CreateGuildBanData::operator String() {
		JsonObject theData{};
	...
	BeginGuildPruneData::operator String() {
		JsonObject theData{};
	...
	ModifyGuildWelcomeScreenData::operator String() {
		JsonObject theData{};
	...
	ModifyGuildData::operator String() {
		JsonObject theData{};
