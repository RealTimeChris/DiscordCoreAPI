...
namespace DiscordCoreInternal {
	...
	std::vector<DiscordCoreAPI::Song> YouTubeRequestBuilder::collectSearchResults(std::string const& searchQuery) {
		try {
	...
	DiscordCoreAPI::YouTubeFormat YouTubeRequestBuilder::decipherFormat(DiscordCoreAPI::YouTubeFormat format, std::string const& html5playerFile) {
	...
	std::string YouTubeRequestBuilder::decipher(std::vector<std::string> tokens, std::string const& cipherSignature) {
	...
	std::vector<std::string> YouTubeRequestBuilder::extractActions(std::string const& html5PlayerPageBody) {
	...
	std::string YouTubeRequestBuilder::between(std::string const& body, std::string const& left, std::string const& right) {
	...
	std::vector<std::string> YouTubeRequestBuilder::getTokens(std::string const& html5PlayerFile) {
	...
	std::vector<char> YouTubeRequestBuilder::splitString(std::string const& stringToSplit) {
	...
	YouTubeAPI::YouTubeAPI(std::string const& guildIdNew, DiscordCoreInternal::HttpClient* httpClient) : requestBuilder(httpClient) {
	...
	std::vector<DiscordCoreAPI::Song> YouTubeAPI::searchForSong(std::string const& searchQuery) {
