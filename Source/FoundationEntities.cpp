...
namespace DiscordCoreAPI {
    ...
    EmbedData& EmbedData::setAuthor(std::string authorName, std::string authorAvatarUrl) {
        this->author.name = authorName;
        this->author.iconUrl = authorAvatarUrl;
        return *this;
    }

    EmbedData& EmbedData::setFooter(std::string footerText, std::string footerIconUrlText) {
        this->footer.text = footerText;
        this->footer.iconUrl = footerIconUrlText;
        return *this;
    }

    EmbedData& EmbedData::setTimeStamp(std::string timeStamp) {
        this->timestamp = timeStamp;
        return *this;
    }

    EmbedData& EmbedData::addField(std::string name, std::string value, bool Inline) {
        this->fields.push_back(EmbedFieldData{ .value = value,.name = name, .Inline = Inline });
        return *this;
    }

    EmbedData& EmbedData::setDescription(std::string descriptionNew) {
        this->description = descriptionNew;
        return *this;
    }

    EmbedData& EmbedData::setColor(std::string hexColorValueNew) {
        this->hexColorValue = hexColorValueNew;
        return *this;
    }

    EmbedData& EmbedData::setThumbnail(std::string thumbnailUrl) {
        this->thumbnail.url = thumbnailUrl;
        return *this;
    }

    EmbedData& EmbedData::setTitle(std::string titleNew) {
        this->title = titleNew;
        return *this;
    }

    EmbedData& EmbedData::setImage(std::string imageUrl) {
        this->image.url = imageUrl;
        return *this;
    }

    RespondToInputEventData::RespondToInputEventData(std::string channelIdNew) {
    ...
    RespondToInputEventData& RespondToInputEventData::addButton(bool disabled, std::string customIdNew, std::string buttonLabel, ButtonStyle buttonStyle, std::string emojiName, std::string emojiId, std::string url) {
    ...
    RespondToInputEventData& RespondToInputEventData::addSelectMenu(bool disabled, std::string customIdNew, std::vector<SelectOptionData> options, std::string placeholder, int32_t maxValues, int32_t minValues) {
        if (this->components.size() == 0) {
            ActionRowData actionRowData;
            this->components.push_back(actionRowData);
        }
    ...
    RespondToInputEventData& RespondToInputEventData::addModal(std::string topTitleNew, std::string topCustomIdNew, std::string titleNew, std::string customIdNew, bool required, int32_t minLength, int32_t maxLength, TextInputStyle inputStyle, std::string label, std::string placeholder) {
    ...
    RespondToInputEventData& RespondToInputEventData::addContent(std::string dataPackage) {
    ...
    RespondToInputEventData& RespondToInputEventData::setTargetUserID(std::string targetUserIdNew) {
