...
namespace DiscordCoreAPI {
	...
	std::unique_ptr<BaseFunction> CommandController::getCommand(std::string const&commandName) {
		try {
	...
	std::unique_ptr<BaseFunction> CommandController::createFunction(std::string const&functionName) {
		try {
