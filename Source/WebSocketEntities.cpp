	...
	void VoiceSocketAgent::run(std::stop_token theToken) noexcept {
		try {
			...
			while (!theToken.stop_requested() && !this->doWeQuit.load()) {
				...
				try {
					if (this->theClients.contains(3) && !this->doWeQuit.load() && !theToken.stop_requested()) {
				...
				if (this->theClients.contains(3) && this->theClients[3] != nullptr && !this->doWeQuit.load() && !theToken.stop_requested()) {
					this->parseHeadersAndMessage(*this->theClients[3]);
					if (this->theClients.contains(3) && this->theClients[3] != nullptr && this->theClients[3]->processedMessages.size() > 0 && !theToken.stop_requested()) {
