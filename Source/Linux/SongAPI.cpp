...
namespace DiscordCoreAPI {
	...
	bool SongAPI::skip(GuildMember guildMember) {
		...
		getVoiceConnectionMap()->at(guildMember.guildId)->skip();
		getVoiceConnectionMap()->at(guildMember.guildId)->play();
		return true;
	}
	...
	bool SongAPI::sendNextSong(GuildMember guildMember) {
		...
		try {
			...
			getVoiceConnectionMap()->at(guildMember.guildId)->onSongCompletionEvent(eventData);
		}
		return false;
	}
};