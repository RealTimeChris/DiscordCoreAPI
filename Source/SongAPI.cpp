...
namespace DiscordCoreAPI {
	...
	SongAPI::SongAPI(const int64_t& guildId) {
		this->guildId = guildId;
	}

	void SongAPI::onSongCompletion(std::function<CoRoutine<void>(SongCompletionEventData)> handler, const int64_t& guildId) {
	...
	bool SongAPI::play(const int64_t& guildId) {
		return getVoiceConnectionMap()[guildId]->play();
	}

	void SongAPI::pauseToggle(const int64_t& guildId) {
		getVoiceConnectionMap()[guildId]->pauseToggle();
	}

	bool SongAPI::areWeCurrentlyPlaying(const int64_t& guildId) {
	...
	void SongAPI::stop(const int64_t& guildId) {
	...
	std::vector<Song> SongAPI::searchForSong(const std::string& searchQuery, const int64_t& guildId) {
	...
	void SongAPI::setLoopAllStatus(bool enabled, const int64_t& guildId) {
		getSongAPIMap()[guildId]->playlist.isLoopAllEnabled = enabled;
	}

	bool SongAPI::isLoopAllEnabled(const int64_t& guildId) {
		return getSongAPIMap()[guildId]->playlist.isLoopAllEnabled;
	}

	void SongAPI::setLoopSongStatus(bool enabled, const int64_t& guildId) {
		getSongAPIMap()[guildId]->playlist.isLoopSongEnabled = enabled;
	}

	bool SongAPI::isLoopSongEnabled(const int64_t& guildId) {
		return getSongAPIMap()[guildId]->playlist.isLoopSongEnabled;
	}

	bool SongAPI::isThereAnySongs(const int64_t& guildId) {
	...
	void SongAPI::setPlaylist(const Playlist& playlistNew, const int64_t& guildId) {
	...
	Playlist SongAPI::getPlaylist(const int64_t& guildId) {
		return getSongAPIMap()[guildId]->playlist;
	}

	void SongAPI::modifyQueue(int32_t firstSongPosition, int32_t secondSongPosition, const int64_t& guildId) {
	...
	Song SongAPI::getCurrentSong(const int64_t& guildId) {
	...
	void SongAPI::setCurrentSong(const Song& song, const int64_t& guildId) {
		getSongAPIMap()[guildId]->playlist.currentSong = song;
	}
