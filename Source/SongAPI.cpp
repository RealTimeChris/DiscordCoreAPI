...
namespace DiscordCoreAPI {
	...
	SongAPI::SongAPI(std::string const& guildId) {
		this->guildId = guildId;
	}

	void SongAPI::onSongCompletion(std::function<CoRoutine<void>(SongCompletionEventData)> handler, std::string const& guildId) {
	...
	bool SongAPI::play(std::string const& guildId) {
		return getVoiceConnectionMap()[guildId]->play();
	}

	void SongAPI::pauseToggle(std::string const& guildId) {
		getVoiceConnectionMap()[guildId]->pauseToggle();
	}

	bool SongAPI::areWeCurrentlyPlaying(std::string const& guildId) {
	...
	void SongAPI::stop(std::string const& guildId) {
	...
	std::vector<Song> SongAPI::searchForSong(std::string const& searchQuery, std::string const& guildId) {
	...
	void SongAPI::setLoopAllStatus(bool enabled, std::string const& guildId) {
		getSongAPIMap()[guildId]->playlist.isLoopAllEnabled = enabled;
	}

	bool SongAPI::isLoopAllEnabled(std::string const& guildId) {
		return getSongAPIMap()[guildId]->playlist.isLoopAllEnabled;
	}

	void SongAPI::setLoopSongStatus(bool enabled, std::string const& guildId) {
		getSongAPIMap()[guildId]->playlist.isLoopSongEnabled = enabled;
	}

	bool SongAPI::isLoopSongEnabled(std::string const& guildId) {
		return getSongAPIMap()[guildId]->playlist.isLoopSongEnabled;
	}

	bool SongAPI::isThereAnySongs(std::string const& guildId) {
	...
	void SongAPI::setPlaylist(Playlist playlistNew, std::string const& guildId) {
	...
	Playlist SongAPI::getPlaylist(std::string const& guildId) {
		return getSongAPIMap()[guildId]->playlist;
	}

	void SongAPI::modifyQueue(int32_t firstSongPosition, int32_t secondSongPosition, std::string const& guildId) {
	...
	Song SongAPI::getCurrentSong(std::string const& guildId) {
	...
	void SongAPI::setCurrentSong(Song song, std::string const& guildId) {
		getSongAPIMap()[guildId]->playlist.currentSong = song;
	}
