...
namespace DiscordCoreInternal {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::OverWriteData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::UserData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::UserData>* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::User>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
            DiscordCoreAPI::UserData newData{};
            DataParser::parseObject(value, &newData);
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildWidgetImageData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ThreadMetadataData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ThreadMemberData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::ThreadMemberData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::Thread* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            if (jsonObjectData["id"].is_string()) {
                pDataStructure->id = jsonObjectData["id"].get<std::string>();
            }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ChannelData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            if (jsonObjectData["id"].is_string()) {
                pDataStructure->id = jsonObjectData["id"].get<std::string>();
            }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::Channel* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            if (jsonObjectData["id"].is_string()) {
                pDataStructure->id = jsonObjectData["id"].get<std::string>();
            }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::ChannelData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::Channel>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::RoleTagsData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::Role* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            if (jsonObjectData["id"].is_string()) {
                pDataStructure->id = jsonObjectData["id"].get<std::string>();
            }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::RoleData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            if (jsonObjectData["id"].is_string()) {
                pDataStructure->id = jsonObjectData["id"].get<std::string>();
            }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::RoleData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::Role>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<std::string>* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildMember* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildMemberData* pDataStructure) {
        if (jsonObjectData.contains("user") && !jsonObjectData["user"].is_null()) {
            DataParser::parseObject(jsonObjectData["user"], &pDataStructure->user);
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::GuildMemberData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::GuildMember>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::EmojiData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::EmojiData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildPreviewData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::VoiceStateData* pDataStructure) {
        if (jsonObjectData.contains("guild_id") && !jsonObjectData["guild_id"].is_null()) {
            pDataStructure->guildId = jsonObjectData["guild_id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::PartyData* pDataStructure) {
        if (jsonObjectData.contains("Id") && !jsonObjectData["Id"].is_null()) {
            pDataStructure->id = jsonObjectData["Id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::AssetsData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::SecretsData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ClientStatusData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::TimestampData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ActivityData* pDataStructure) {
        if (jsonObjectData.contains("Name") && !jsonObjectData["Name"].is_null()) {
            pDataStructure->name = jsonObjectData["Name"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::PresenceUpdateData* pDataStructure) {
        if (jsonObjectData.contains("user") && !jsonObjectData["user"].is_null()) {
            DataParser::parseObject(jsonObjectData["user"], &pDataStructure->user);
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::WelcomeScreenChannelData* pDataStructure) {
        if (jsonObjectData.contains("channel_id") && !jsonObjectData["channel_id"].is_null()) {
            pDataStructure->channelId = jsonObjectData["channel_id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::WelcomeScreenData* pDataStructure) {
        if (jsonObjectData.contains("description") && !jsonObjectData["description"].is_null()) {
            pDataStructure->description = jsonObjectData["description"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::StageInstance* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::StageInstanceData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::Sticker* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::StickerData* pDataStructure) {
        if (jsonObjectData.contains("asset") && !jsonObjectData["asset"].is_null()) {
            pDataStructure->asset = jsonObjectData["asset"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::StickerData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::Sticker>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::VoiceRegionData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::VoiceRegionData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildPruneCountData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::Guild* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
            pDataStructure->createdAt = pDataStructure->getCreatedAtTimestamp(DiscordCoreAPI::TimeFormat::LongDateTime);
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
            pDataStructure->createdAt = pDataStructure->getCreatedAtTimestamp(DiscordCoreAPI::TimeFormat::LongDateTime);
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::Guild>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::SessionStartData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GatewayBotData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::GuildData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildWidgetData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ChannelMentionData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::AttachmentData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::EmbedFooterData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::EmbedImageData* pDataStructure) {
        if (jsonObjectData.contains("url") && !jsonObjectData["url"].is_null()) {
            pDataStructure->url = jsonObjectData["url"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::EmbedThumbnailData* pDataStructure) {
        if (jsonObjectData.contains("url") && !jsonObjectData["url"].is_null()) {
            pDataStructure->url = jsonObjectData["url"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::EmbedVideoData* pDataStructure) {
        if (jsonObjectData.contains("url") && !jsonObjectData["url"].is_null()) {
            pDataStructure->url = jsonObjectData["url"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::EmbedAuthorData* pDataStructure) {
        if (jsonObjectData.contains("url") && !jsonObjectData["url"].is_null()) {
            pDataStructure->url = jsonObjectData["url"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::EmbedProviderData* pDataStructure) {
        if (jsonObjectData.contains("url") && !jsonObjectData["url"].is_null()) {
            pDataStructure->url = jsonObjectData["url"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::EmbedFieldData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::EmbedData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::Reaction* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ReactionData* pDataStructure) {
        if (jsonObjectData.contains("count") && !jsonObjectData["count"].is_null()) {
            pDataStructure->count = jsonObjectData["count"].get<int32_t>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::ReactionData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::MessageActivityData* pDataStructure) {
        if (jsonObjectData.contains("type") && !jsonObjectData["type"].is_null()) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::TeamMembersObjectData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::TeamObjectData* pDataStructure) {
        if (jsonObjectData.contains("icon") && !jsonObjectData["icon"].is_null()) {
            pDataStructure->icon = jsonObjectData["icon"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ApplicationData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildScheduledEventMetadata* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildScheduledEvent* pDataStructure) {
        if (jsonObjectData.contains("privacy_level") && !jsonObjectData["privacy_level"].is_null()) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildScheduledEventData* pDataStructure) {
        if (jsonObjectData.contains("privacy_level") && !jsonObjectData["privacy_level"].is_null()) {
            pDataStructure->privacyLevel = jsonObjectData.at("privacy_level").get<DiscordCoreAPI::GuildScheduledEventPrivacyLevel>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::GuildScheduledEventData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::GuildScheduledEvent>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildTemplateData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::GuildTemplateData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildScheduledEventUserData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::GuildScheduledEventUserData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::MessageReferenceData* pDataStructure) {
        if (jsonObjectData.contains("message_id") && !jsonObjectData["message_id"].is_null()) {
            pDataStructure->messageId = jsonObjectData["message_id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::AllowedMentionsData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::InteractionApplicationCommandCallbackData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::InteractionResponseData* pDataStructure) {
        if (jsonObjectData.contains("type") && !jsonObjectData["type"].is_null()) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::SelectOptionData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ActionRowData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::MessageInteractionData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::StickerItemData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::MessageDataOld* pDataStructure) {
        if (jsonObjectData.contains("content") && !jsonObjectData["content"].is_null()) {
            pDataStructure->content = jsonObjectData["content"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::Message* pDataStructure) {
        if (jsonObjectData.contains("content") && !jsonObjectData["content"].is_null()) {
            pDataStructure->content = jsonObjectData["content"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::MessageData* pDataStructure) {
        if (jsonObjectData.contains("content") && !jsonObjectData["content"].is_null()) {
            pDataStructure->content = jsonObjectData["content"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::MessageData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::Message>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ApplicationCommandOptionChoiceData* pDataStructure) {
        if (jsonObjectData.contains("name") && !jsonObjectData["name"].is_null()) {
            pDataStructure->name = jsonObjectData["name"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ApplicationCommandOptionData* pDataStructure) {
        if (jsonObjectData.contains("name") && !jsonObjectData["name"].is_null()) {
            pDataStructure->name = jsonObjectData["name"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ApplicationCommand* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ApplicationCommandData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::ApplicationCommandData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::ApplicationCommand>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ApplicationCommandInteractionDataOption* pDataStructure) {
        if (jsonObjectData.contains("name") && !jsonObjectData["name"].is_null()) {
            pDataStructure->name = jsonObjectData["name"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::YouTubeFormat>* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::CommandData* pDataStructure) {
        if (jsonObjectData.contains("options") && !jsonObjectData["options"].is_null()) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ApplicationCommandInteractionData* pDataStructure) {
        if (jsonObjectData.contains("type") && !jsonObjectData["type"].is_null()) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::MessageCommandInteractionData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::UserCommandInteractionData* pDataStructure) {
        if (jsonObjectData.contains("target_id") && !jsonObjectData["target_id"].is_null()) {
            pDataStructure->targetId = jsonObjectData["target_id"].get<std::string>();
        }
    }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::StickerPackData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::StickerPackData>* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ComponentInteractionData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::InteractionDataData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::InteractionData* pDataStructure) {
        if (jsonObjectData.contains("data") && !jsonObjectData["data"].is_null()) {
            DataParser::parseObject(jsonObjectData["data"], &pDataStructure->data);
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ReactionRemoveData* pDataStructure) {
        if (jsonObjectData.contains("user_id") && !jsonObjectData["user_id"].is_null()) {
            pDataStructure->userId = jsonObjectData["user_id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::WebHook* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::WebHookData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::WebHookData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::WebHook>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::AuditLogChangeData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::AuditLogEntryInfoData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::AuditLogEntryData* pDataStructure) {
        if (jsonObjectData.contains("target_id") && !jsonObjectData["target_id"].is_null()) {
            pDataStructure->targetId = jsonObjectData["target_id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::AccountData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::IntegrationData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::IntegrationData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ConnectionData* pDataStructure) {
        if (jsonObjectData.contains("name") && !jsonObjectData["name"].is_null()) {
            pDataStructure->name = jsonObjectData["name"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::AuditLogData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::TypingStartData* pDataStructure) {
        if (jsonObjectData.contains("channel_id") && !jsonObjectData["channel_id"].is_null()) {
            pDataStructure->channelId = jsonObjectData["channel_id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ChannelPinsUpdateEventData* pDataStructre) {
        if (jsonObjectData.contains("guild_id") && !jsonObjectData["guild_id"].is_null()) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::BanData* pDataStructure) {
        if (jsonObjectData.contains("user") && !jsonObjectData["user"].is_null()) {
            DataParser::parseObject(jsonObjectData["user"], &pDataStructure->user);
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::BanData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ThreadListSyncData* pDataStructure) {
        if (jsonObjectData.contains("guild_id") && !jsonObjectData["guild_id"].is_null()) {
            pDataStructure->guildId = jsonObjectData["guild_id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ThreadMembersUpdateData* pDataStructure) {
        if (jsonObjectData.contains("guild_id") && !jsonObjectData["guild_id"].is_null()) {
            pDataStructure->guildId = jsonObjectData["guild_id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ArchivedThreadsData* pDataStructure) {
        if (jsonObjectData.contains("threads") && !jsonObjectData["threads"].is_null()) {
            pDataStructure->threads.clear();
            pDataStructure->threads.reserve(jsonObjectData.at("threads").size());
            for (auto& value : jsonObjectData["threads"]) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ActiveThreadsData* pDataStructure) {
        if (jsonObjectData.contains("threads") && !jsonObjectData["threads"].is_null()) {
            pDataStructure->threads.clear();
            pDataStructure->threads.reserve(jsonObjectData.at("threads").size());
            for (auto& value : jsonObjectData["threads"]) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildEmojisUpdateEventData* pDataStructure) {
        if (jsonObjectData.contains("guild_id") && !jsonObjectData["guild_id"].is_null()) {
            pDataStructure->guildId = jsonObjectData["guild_id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildStickersUpdateEventData* pDataStructure) {
        if (jsonObjectData.contains("guild_id") && !jsonObjectData["guild_id"].is_null()) {
            pDataStructure->guildId = jsonObjectData["guild_id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildMembersChunkEventData* pDataStructure) {
        if (jsonObjectData.contains("guild_id") && !jsonObjectData["guild_id"].is_null()) {
            pDataStructure->guildId = jsonObjectData["guild_id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::ApplicationCommandPermissionData* pDataStructure) {
        if (jsonObjectData.contains("id") && !jsonObjectData["id"].is_null()) {
            pDataStructure->id = jsonObjectData["id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::GuildApplicationCommandPermissionsData* pDataStructure) {
        if (jsonObjectData.contains("guild_id") && !jsonObjectData["guild_id"].is_null()) {
            pDataStructure->guildId = jsonObjectData["guild_id"].get<std::string>();
        }
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::GuildApplicationCommandPermissionsData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::YouTubeSong* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::SoundCloudSong* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::AuthorizationInfoData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, DiscordCoreAPI::InviteData* pDataStructure) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::ConnectionData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
    ...
    template<>
    static void DataParser::parseObject(nlohmann::json& jsonObjectData, std::vector<DiscordCoreAPI::InviteData>* pDataStructure) {
        pDataStructure->reserve(jsonObjectData.size());
        for (auto& value : jsonObjectData) {
