...
namespace DiscordCoreAPI {
	...
	OnGuildMemberUpdateData::OnGuildMemberUpdateData(GuildMemberData* newGuildMember) {
		this->guildMember = newGuildMember;
	}
	...
	OnUserUpdateData::OnUserUpdateData(UserData* newUser) {
		this->user = newUser;
	}
