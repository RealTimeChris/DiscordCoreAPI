...
namespace DiscordCoreAPI {
    ...
    CoRoutine<std::vector<ModalResponseData>> ModalCollector::collectModalData(bool getButtonDataForAllNew, int32_t maxWaitTimeInMsNew, int32_t maxNumberOfPressesNew, std::string targetUser) {
