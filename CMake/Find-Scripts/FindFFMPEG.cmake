# find_ffmpeg(RELEASE_ROOT_DIR DEBUG_ROOT_DIR INCLUDE_DIR)
#
...
#
function(find_ffmpeg RELEASE_ROOT_DIR DEBUG_ROOT_DIR INCLUDE_DIR)
	find_library(
	...
	if (EXISTS "${AVCODEC_RELEASE_LIBRARY}" AND EXISTS "${AVCODEC_DEBUG_LIBRARY}" AND EXISTS "${AVFORMAT_RELEASE_LIBRARY}"
		...
		AND EXISTS "${SWRESAMPLE_RELEASE_LIBRARY}" AND EXISTS "${SWRESAMPLE_DEBUG_LIBRARY}" AND EXISTS "${INCLUDE_DIR}")
