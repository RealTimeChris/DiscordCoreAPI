...
if (EXISTS "${CURL_RELEASE_DLL}" AND EXISTS "${CURL_DEBUG_DLL}")
	...
	if (CURLLIB_FOUND)
		...
		add_library(CURLLib::Curl SHARED IMPORTED GLOBAL)
		set_target_properties(
			CURLLib::Curl PROPERTIES 
		...
		target_include_directories(CURLLib::Curl INTERFACE "${INCLUDE_DIR}")
	endif()
else()
	find_package_handle_standard_args(
		CURLLib
	...
	if (CURL_FOUND)
		...
		set(CURL_INCLUDE_DIRS "${CURL_INCLUDE_DIR}")
		add_library(CURLLib::Curl STATIC IMPORTED GLOBAL)
		set_target_properties(
			CURLLib::Curl PROPERTIES 
