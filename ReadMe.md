...
## A bot library for Discord, written in C++ using a few useful libraries. Features explicit multithreading, through the usage of custom, asynchronous C++ CoRoutines.
