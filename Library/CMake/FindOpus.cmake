...
function(find_opus RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if (OPUS_RELEASE_LIBRARY AND OPUS_DEBUG_LIBRARY)
		list(APPEND RELEASE_LIBRARIES_RAW "${OPUS_RELEASE_LIBRARY}")
		list(APPEND DEBUG_LIBRARIES_RAW  "${OPUS_DEBUG_LIBRARY}")
	...
	if (WIN32)
		...
		if (OPUS_RELEASE_DLL AND OPUS_DEBUG_DLL)
			...
			list(APPEND RELEASE_DLLS_RAW "${OPUS_RELEASE_DLL}")
			list(APPEND DEBUG_DLLS_RAW  "${OPUS_DEBUG_DLL}")
