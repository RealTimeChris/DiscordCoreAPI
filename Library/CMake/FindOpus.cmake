...
function(find_opus RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if (OPUS_RELEASE_LIBRARY AND OPUS_DEBUG_LIBRARY)
		set(OPUS_RELEASE_LIBRARY "${OPUS_RELEASE_LIBRARY}" PARENT_SCOPE)
		set(OPUS_DEBUG_LIBRARY "${OPUS_DEBUG_LIBRARY}" PARENT_SCOPE)
	...
	if (WIN32)
		...
		if (OPUS_RELEASE_DLL AND OPUS_DEBUG_DLL)
			set(OPUS_RELEASE_DLL "${OPUS_RELEASE_DLL}" PARENT_SCOPE)
			set(OPUS_DEBUG_DLL "${OPUS_DEBUG_DLL}" PARENT_SCOPE)
			message(STATUS "Found Opus Dlls!")
		else()
			set(OPUS_RELEASE_DLL "${CMAKE_SOURCE_DIR}/Include/discordcoreapi/Index.hpp" PARENT_SCOPE)
			set(OPUS_DEBUG_DLL "${CMAKE_SOURCE_DIR}/Include/discordcoreapi/Index.hpp" PARENT_SCOPE)
