...
function(find_opus RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if (OPUS_RELEASE_LIBRARY AND OPUS_DEBUG_LIBRARY)
		cmake_path(GET OPUS_RELEASE_LIBRARY FILENAME OPUS_RELEASE_LIBRARY_NAME)
		cmake_path(GET OPUS_RELEASE_LIBRARY PARENT_PATH OPUS_RELEASE_FILE_PATH)
		cmake_path(RELATIVE_PATH OPUS_RELEASE_FILE_PATH OUTPUT_VARIABLE OPUS_RELEASE_LIBRARY_NEW)
		cmake_path(GET OPUS_DEBUG_LIBRARY FILENAME OPUS_DEBUG_LIBRARY_NAME)
		cmake_path(GET OPUS_DEBUG_LIBRARY PARENT_PATH OPUS_DEBUG_FILE_PATH)
		cmake_path(RELATIVE_PATH OPUS_DEBUG_FILE_PATH OUTPUT_VARIABLE OPUS_DEBUG_LIBRARY_NEW)
		list(APPEND RELEASE_LIBRARIES "${OPUS_RELEASE_LIBRARY_NEW}/${OPUS_RELEASE_LIBRARY_NAME}")
		list(APPEND DEBUG_LIBRARIES "${OPUS_DEBUG_LIBRARY_NEW}/${OPUS_DEBUG_LIBRARY_NAME}")
