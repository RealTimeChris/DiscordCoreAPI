...
function(find_intl RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if(INTL_RELEASE_LIBRARY AND INTL_DEBUG_LIBRARY)
		cmake_path(GET INTL_RELEASE_LIBRARY FILENAME INTL_RELEASE_LIBRARY_NAME)
		cmake_path(GET INTL_RELEASE_LIBRARY PARENT_PATH INTL_RELEASE_FILE_PATH)
		cmake_path(RELATIVE_PATH INTL_RELEASE_FILE_PATH OUTPUT_VARIABLE INTL_RELEASE_LIBRARY_NEW)
		cmake_path(GET INTL_DEBUG_LIBRARY FILENAME INTL_DEBUG_LIBRARY_NAME)
		cmake_path(GET INTL_DEBUG_LIBRARY PARENT_PATH INTL_DEBUG_FILE_PATH)
		cmake_path(RELATIVE_PATH INTL_DEBUG_FILE_PATH OUTPUT_VARIABLE INTL_DEBUG_LIBRARY_NEW)
		list(APPEND RELEASE_LIBRARIES "${INTL_RELEASE_LIBRARY_NEW}/${INTL_RELEASE_LIBRARY_NAME}")
		list(APPEND DEBUG_LIBRARIES "${INTL_DEBUG_LIBRARY_NEW}/${INTL_DEBUG_LIBRARY_NAME}")
