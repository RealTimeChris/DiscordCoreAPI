...
function(find_intl RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if(INTL_RELEASE_LIBRARY AND INTL_DEBUG_LIBRARY)
		list(APPEND RELEASE_LIBRARIES_RAW "${INTL_RELEASE_LIBRARY}")
		list(APPEND DEBUG_LIBRARIES_RAW  "${INTL_DEBUG_LIBRARY}")
	...
	if (WIN32)
		...
		if (INTL_RELEASE_DLL AND INTL_DEBUG_DLL)
			...
			list(APPEND RELEASE_DLLS_RAW "${INTL_RELEASE_DLL}")
			list(APPEND DEBUG_DLLS_RAW  "${INTL_DEBUG_DLL}")
