...
function(find_glib RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if(GLIB_RELEASE_LIBRARY AND GLIB_DEBUG_LIBRARY)
		set(GLIB_RELEASE_LIBRARY "${GLIB_RELEASE_LIBRARY}" PARENT_SCOPE)
		set(GLIB_DEBUG_LIBRARY "${GLIB_DEBUG_LIBRARY}" PARENT_SCOPE)
	...
	if (WIN32)
		...
		if (GLIB_RELEASE_DLL AND GLIB_DEBUG_DLL)
			set(GLIB_RELEASE_DLL "${GLIB_RELEASE_DLL}" PARENT_SCOPE)
			set(GLIB_DEBUG_DLL "${GLIB_DEBUG_DLL}" PARENT_SCOPE)
