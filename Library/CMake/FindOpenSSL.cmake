...
function(find_openssl RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if (LIBSSL_RELEASE_LIBRARY AND LIBSSL_DEBUG_LIBRARY AND LIBCRYPTO_RELEASE_LIBRARY AND LIBCRYPTO_DEBUG_LIBRARY)
		list(APPEND RELEASE_LIBRARIES_RAW "${LIBSSL_RELEASE_LIBRARY}")
		list(APPEND DEBUG_LIBRARIES_RAW  "${LIBSSL_DEBUG_LIBRARY}")
		list(APPEND RELEASE_LIBRARIES_RAW "${LIBCRYPTO_RELEASE_LIBRARY}")
		list(APPEND DEBUG_LIBRARIES_RAW  "${LIBCRYPTO_DEBUG_LIBRARY}")
	...
	if (WIN32)
		...
		if (LIBSSL_RELEASE_DLL AND LIBSSL_DEBUG_DLL AND LIBCRYPTO_RELEASE_DLL AND LIBCRYPTO_DEBUG_DLL)
			...
			list(APPEND RELEASE_DLLS_RAW "${LIBSSL_RELEASE_DLL}")
			list(APPEND DEBUG_DLLS_RAW  "${LIBSSL_DEBUG_DLL}")
			list(APPEND RELEASE_DLLS_RAW "${LIBCRYPTO_RELEASE_DLL}")
			list(APPEND DEBUG_DLLS_RAW  "${LIBCRYPTO_DEBUG_DLL}")
