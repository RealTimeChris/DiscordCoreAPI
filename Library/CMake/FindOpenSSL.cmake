...
function(find_openssl RELEASE_ROOT_DIR DEBUG_ROOT_DIR SHARED)
	...
	if (LIBSSL_LIBRARY_RELEASE AND LIBSSL_LIBRARY_DEBUG AND LIBCRYPTO_LIBRARY_RELEASE AND LIBCRYPTO_LIBRARY_DEBUG)
		list(APPEND RELEASE_LIBRARIES "${LIBSSL_LIBRARY_RELEASE}")
		list(APPEND DEBUG_LIBRARIES  "${LIBSSL_LIBRARY_DEBUG}")
		list(APPEND RELEASE_LIBRARIES "${LIBCRYPTO_LIBRARY_RELEASE}")
		list(APPEND DEBUG_LIBRARIES  "${LIBCRYPTO_LIBRARY_DEBUG}")
	...
	if ("${SHARED}")
		...
		if (LIBSSL_RUNTIME_RELEASE AND LIBSSL_RUNTIME_DEBUG AND LIBCRYPTO_RUNTIME_RELEASE AND LIBCRYPTO_RUNTIME_DEBUG)
			list(APPEND LIBRARY_NAMES "LIBSSL")
			list(APPEND RELEASE_RUNTIMES "${LIBSSL_RUNTIME_RELEASE}")
			list(APPEND DEBUG_RUNTIMES  "${LIBSSL_RUNTIME_DEBUG}")
			list(APPEND LIBRARY_NAMES "LIBCRYPTO")
			list(APPEND RELEASE_RUNTIMES "${LIBCRYPTO_RUNTIME_RELEASE}")
			list(APPEND DEBUG_RUNTIMES  "${LIBCRYPTO_RUNTIME_DEBUG}")
			...
			message(STATUS "Couldn't find OpenSSL Dlls!")
			unset(LIBCRYPTO_RUNTIME_RELEASE CACHE)
			unset(LIBCRYPTO_RUNTIME_DEBUG CACHE)
			unset(LIBSSL_RUNTIME_RELEASE CACHE)
			unset(LIBSSL_RUNTIME_DEBUG CACHE)
		endif()
	endif()
endfunction()