...
function(find_ffmpeg RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if (AVCODEC_RELEASE_LIBRARY AND AVCODEC_DEBUG_LIBRARY AND AVFORMAT_RELEASE_LIBRARY AND AVFORMAT_DEBUG_LIBRARY AND AVUTIL_RELEASE_LIBRARY
		...
		set(AVFORMAT_RELEASE_LIBRARY "${AVFORMAT_RELEASE_LIBRARY}" PARENT_SCOPE)
		set(AVFORMAT_DEBUG_LIBRARY "${AVFORMAT_DEBUG_LIBRARY}" PARENT_SCOPE)
		set(AVCODEC_RELEASE_LIBRARY "${AVCODEC_RELEASE_LIBRARY}" PARENT_SCOPE)
		set(AVCODEC_DEBUG_LIBRARY "${AVCODEC_DEBUG_LIBRARY}" PARENT_SCOPE)
		set(AVUTIL_RELEASE_LIBRARY "${AVUTIL_RELEASE_LIBRARY}" PARENT_SCOPE)
		set(AVUTIL_DEBUG_LIBRARY "${AVUTIL_DEBUG_LIBRARY}" PARENT_SCOPE)
		set(SWRESAMPLE_RELEASE_LIBRARY "${SWRESAMPLE_RELEASE_LIBRARY}" PARENT_SCOPE)
		set(SWRESAMPLE_DEBUG_LIBRARY "${SWRESAMPLE_DEBUG_LIBRARY}" PARENT_SCOPE)
	...
	if (WIN32)
		...
		if (AVCODEC_RELEASE_DLL AND AVCODEC_DEBUG_DLL AND AVFORMAT_RELEASE_DLL AND AVFORMAT_DEBUG_DLL 
			...
			set(AVFORMAT_RELEASE_DLL "${AVFORMAT_RELEASE_DLL}" PARENT_SCOPE)
			set(AVFORMAT_DEBUG_DLL "${AVFORMAT_DEBUG_DLL}" PARENT_SCOPE)
			set(AVCODEC_RELEASE_DLL "${AVCODEC_RELEASE_DLL}" PARENT_SCOPE)
			set(AVCODEC_DEBUG_DLL "${AVCODEC_DEBUG_DLL}" PARENT_SCOPE)
			set(AVUTIL_RELEASE_DLL "${AVUTIL_RELEASE_DLL}" PARENT_SCOPE)
			set(AVUTIL_DEBUG_DLL "${AVUTIL_DEBUG_DLL}" PARENT_SCOPE)
			set(SWRESAMPLE_RELEASE_DLL "${SWRESAMPLE_RELEASE_DLL}" PARENT_SCOPE)
			set(SWRESAMPLE_DEBUG_DLL "${SWRESAMPLE_DEBUG_DLL}" PARENT_SCOPE)
