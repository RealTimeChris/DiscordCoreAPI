...
function(find_ffmpeg RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if (AVCODEC_RELEASE_LIBRARY AND AVCODEC_DEBUG_LIBRARY AND AVFORMAT_RELEASE_LIBRARY AND AVFORMAT_DEBUG_LIBRARY AND AVUTIL_RELEASE_LIBRARY
		...
		list(APPEND RELEASE_LIBRARIES "${AVFORMAT_RELEASE_LIBRARY}")
		list(APPEND DEBUG_LIBRARIES  "${AVFORMAT_DEBUG_LIBRARY}")
		list(APPEND RELEASE_LIBRARIES "${AVCODEC_RELEASE_LIBRARY}")
		list(APPEND DEBUG_LIBRARIES  "${AVCODEC_DEBUG_LIBRARY}")
		list(APPEND RELEASE_LIBRARIES "${AVUTIL_RELEASE_LIBRARY}")
		list(APPEND DEBUG_LIBRARIES  "${AVUTIL_DEBUG_LIBRARY}")
		list(APPEND RELEASE_LIBRARIES "${SWRESAMPLE_RELEASE_LIBRARY}")
		list(APPEND DEBUG_LIBRARIES  "${SWRESAMPLE_DEBUG_LIBRARY}")
