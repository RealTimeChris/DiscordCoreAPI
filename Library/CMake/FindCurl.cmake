...
function(find_curl RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if(CURL_RELEASE_LIBRARY AND CURL_DEBUG_LIBRARY)
		set(CURL_RELEASE_LIBRARY "${CURL_RELEASE_LIBRARY}" PARENT_SCOPE)
		set(CURL_DEBUG_LIBRARY "${CURL_DEBUG_LIBRARY}" PARENT_SCOPE)
	...
	if (WIN32)
		...
		if (CURL_RELEASE_DLL AND CURL_DEBUG_DLL)
			set(CURL_RELEASE_DLL "${CURL_RELEASE_DLL}" PARENT_SCOPE)
			set(CURL_DEBUG_DLL "${CURL_DEBUG_DLL}" PARENT_SCOPE)
