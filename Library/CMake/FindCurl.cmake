...
function(find_curl RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if(CURL_RELEASE_LIBRARY AND CURL_DEBUG_LIBRARY)
		cmake_path(GET CURL_RELEASE_LIBRARY FILENAME RELEASE_LIBRARY_NAME)
		cmake_path(GET CURL_RELEASE_LIBRARY PARENT_PATH RELEASE_FILE_PATH)
		cmake_path(RELATIVE_PATH RELEASE_FILE_PATH OUTPUT_VARIABLE RELEASE_LIBRARY_NEW)
		cmake_path(GET CURL_DEBUG_LIBRARY FILENAME DEBUG_LIBRARY_NAME)
		cmake_path(GET CURL_DEBUG_LIBRARY PARENT_PATH DEBUG_FILE_PATH)
		cmake_path(RELATIVE_PATH DEBUG_FILE_PATH OUTPUT_VARIABLE DEBUG_LIBRARY_NEW)
		list(APPEND RELEASE_LIBRARIES "${RELEASE_LIBRARY_NEW}/${RELEASE_LIBRARY_NAME}")
		list(APPEND DEBUG_LIBRARIES "${DEBUG_LIBRARY_NEW}/${DEBUG_LIBRARY_NAME}")
