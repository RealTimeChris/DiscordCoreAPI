...
function(find_sodium RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if (SODIUM_RELEASE_LIBRARY AND SODIUM_DEBUG_LIBRARY)
		set(SODIUM_RELEASE_LIBRARY "${SODIUM_RELEASE_LIBRARY}" PARENT_SCOPE)
		set(SODIUM_DEBUG_LIBRARY "${SODIUM_DEBUG_LIBRARY}" PARENT_SCOPE)
	...
	if (WIN32)
		...
		if (SODIUM_RELEASE_DLL AND SODIUM_DEBUG_DLL)
			set(SODIUM_RELEASE_DLL "${SODIUM_RELEASE_DLL}" PARENT_SCOPE)
			set(SODIUM_DEBUG_DLL "${SODIUM_DEBUG_DLL}" PARENT_SCOPE)
