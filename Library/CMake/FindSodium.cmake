...
function(find_sodium RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	...
	if (SODIUM_RELEASE_LIBRARY AND SODIUM_DEBUG_LIBRARY)
		list(APPEND RELEASE_LIBRARIES "${SODIUM_RELEASE_LIBRARY}")
		list(APPEND DEBUG_LIBRARIES  "${SODIUM_DEBUG_LIBRARY}")
	...
	if (WIN32)
		...
		if (SODIUM_RELEASE_DLL AND SODIUM_DEBUG_DLL)
			...
			list(APPEND RELEASE_DLLS "${SODIUM_RELEASE_DLL}")
			list(APPEND DEBUG_DLLS  "${SODIUM_DEBUG_DLL}")
