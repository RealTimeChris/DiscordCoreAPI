...
function(find_libz RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	if (UNIX)
		...
		if(LIBZ_RELEASE_LIBRARY AND LIBZ_DEBUG_LIBRARY)
			cmake_path(GET LIBZ_RELEASE_LIBRARY FILENAME LIBZ_RELEASE_LIBRARY_NAME)
			cmake_path(GET LIBZ_RELEASE_LIBRARY PARENT_PATH LIBZ_RELEASE_FILE_PATH)
			cmake_path(RELATIVE_PATH LIBZ_RELEASE_FILE_PATH OUTPUT_VARIABLE LIBZ_RELEASE_LIBRARY_NEW)
			cmake_path(GET LIBZ_DEBUG_LIBRARY FILENAME LIBZ_DEBUG_LIBRARY_NAME)
			cmake_path(GET LIBZ_DEBUG_LIBRARY PARENT_PATH LIBZ_DEBUG_FILE_PATH)
			cmake_path(RELATIVE_PATH LIBZ_DEBUG_FILE_PATH OUTPUT_VARIABLE LIBZ_DEBUG_LIBRARY_NEW)
			list(APPEND RELEASE_LIBRARIES "${LIBZ_RELEASE_LIBRARY_NEW}/${LIBZ_RELEASE_LIBRARY_NAME}")
			list(APPEND DEBUG_LIBRARIES "${LIBZ_DEBUG_LIBRARY_NEW}/${LIBZ_DEBUG_LIBRARY_NAME}")
