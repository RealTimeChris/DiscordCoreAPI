...
function(find_libz RELEASE_ROOT_DIR DEBUG_ROOT_DIR)
	if (UNIX)
		...
		if(LIBZ_RELEASE_LIBRARY AND LIBZ_DEBUG_LIBRARY)
			list(APPEND RELEASE_LIBRARIES_RAW "${LIBZ_RELEASE_LIBRARY}")
			list(APPEND DEBUG_LIBRARIES_RAW  "${LIBZ_DEBUG_LIBRARY}")
		...
		if (WIN32)
			...
			if (LIBZ_RELEASE_DLL AND LIBZ_DEBUG_DLL)
				...
				list(APPEND RELEASE_DLLS_RAW "${LIBZ_RELEASE_DLL}")
				list(APPEND DEBUG_DLLS_RAW  "${LIBZ_DEBUG_DLL}")
