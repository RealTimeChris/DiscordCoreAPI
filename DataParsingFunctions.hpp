    ...
    public:
        ...
        static void parseObject(json jsonObjectData, DiscordCoreAPI::StickerData* pDataStructure) {
            ...
            if (jsonObjectData.contains("sort_value") && !jsonObjectData.at("sort_value").is_null()) {
                newData.sortValue = jsonObjectData.at("sort_value").get<int>();
            }
        ...
        static void parseObject(json jsonObjectData, DiscordCoreAPI::MessageStickerData* pDataStructure) {
        ...
        static void parseObject(json jsonObjectData, DiscordCoreAPI::ReactionAddData* pDataStructure) {
        ...
        static void parseObject(json jsonObjectData, DiscordCoreAPI::MessageStickerItemData* pDataStructure) {
        ...
        static void parseObject(json jsonObjectData, DiscordCoreAPI::ComponentInteractionData* pDataStructure) {
            ...
            if (jsonObjectData.contains("values") && !jsonObjectData.at("values").is_null()) {
                vector<DiscordCoreAPI::SelectOptionData> newVector{};
                for (auto value : jsonObjectData.at("values")) {
                    DiscordCoreAPI::SelectOptionData newData{};
                    parseObject(value, &newData);
                }
