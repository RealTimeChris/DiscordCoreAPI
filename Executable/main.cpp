...
int32_t main()
{
    ...
    auto thePtr = std::make_unique<DiscordCoreAPI::DiscordCoreClient>(botToken, "!", functionVector, DiscordCoreAPI::CacheOptions{ .cacheGuildMembers = true, .cacheChannels = true, .cacheGuilds = true, .cacheRoles = true, .cacheUsers = true }, DiscordCoreAPI::ShardingOptions{}, DiscordCoreAPI::LoggingOptions{});
