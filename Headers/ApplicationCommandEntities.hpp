...
namespace DiscordCoreAPI {
    ...
    */
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll GetGlobalApplicationCommandData {
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll CreateGlobalApplicationCommandData {
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll EditGlobalApplicationCommandData {
        vector<ApplicationCommandOptionData> options{};///< The options for the ApplicationCommand.
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll DeleteGlobalApplicationCommandData {
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll BulkOverwriteGlobalApplicationCommandsData {
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll GetGuildApplicationCommandsData {
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll CreateGuildApplicationCommandData {
        vector<ApplicationCommandOptionData> options{}; ///< The options for the ApplicationCommand.
        bool defaultPermission{ true }; ///< Whether the command is enabled by default when the bot is added to a Guild.
        ApplicationCommandType type{}; ///< The type of ApplicationCommand.
        string description{ "" };   ///< A description of the command.
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll GetGuildApplicationCommandData {
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll EditGuildApplicationCommandData {
        vector<ApplicationCommandOptionData> options{}; ///< The options for the ApplicationCommand.
        bool defaultPermission{ true }; ///< Whether the command is enabled by default when the bot is added to a Guild.
        string description{ "" };   ///< A description of the command.
        string guildId{ "" }; ///< The id of the Guild which you would like to add the new command to.
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll DeleteGuildApplicationCommandData {
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll BulkOverwriteGuildApplicationCommandsData {
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll GetGuildApplicationCommandPermissionsData {
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll GetApplicationCommandPermissionsData {
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll EditGuildApplicationCommandPermissionsData {
    ...
    struct alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll BatchEditGuildApplicationCommandPermissionsData {
    ...
    * @{
    */
    /// An interface class alignas(hardware_destructive_interference_size) for the ApplicationCommand related Discord endpoints. \brief An interface class alignas(hardware_destructive_interference_size) for the ApplicationCommand related Discord endpoints.
    class alignas(hardware_destructive_interference_size) DiscordCoreAPI_Dll ApplicationCommands {
    public:
