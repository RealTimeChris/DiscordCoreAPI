// AsyncGenerator.hpp - Header for the Async-Generator class.
// Nov 12, 2021
// Chris M.
...
namespace cppcoro
{
	...
	namespace detail
	{
		...
		inline bool async_generator_yield_operation::await_suspend(
			::coroutine_handle<> producer) noexcept
		{
		...
		protected:
			...
			async_generator_advance_operation(
				...
				::coroutine_handle<> producerCoroutine) noexcept
	...
	public:
		...
		explicit async_generator(promise_type& promise) noexcept
			: m_coroutine(::coroutine_handle<promise_type>::from_promise(promise))
		{}
